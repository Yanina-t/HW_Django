                    ...
                    <div class="col">
                        <div class="collapse collapse-horizontal" id="collapseWidthExample">
                            <div class="card card-body" style="width: 300px;">
                                Для покупки товара онлайн выберите товар и оплатите через сайт.
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="collapse collapse-horizontal" id="collapseWidthExample2">
                            <div class="card card-body" style="width: 300px;">
                                Доставка осуществляется по указанному адресу согласно выбранному способу и сроку.
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="collapse collapse-horizontal" id="collapseWidthExample3">
                            <div class="card card-body" style="width: 300px;">
                                Гарантия включает срок и условия, а также возможность обмена товара.
                            </div>
                        </div>
                    </div>
                </div>
